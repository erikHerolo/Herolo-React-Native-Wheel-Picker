  ...
  const createList = useCallback((itemStyles, selectedColor, animationValue) => {
    return [
      ...
      ...options.map((value, index) => {
        ...
        const tightInputRange = [inputRange[0], inputRange[numOfDisplayedItems]]
            ...
            >
              <ItemText
                ...
                style={[{
                  ...
                  opacity: animationValue.interpolate({
                    inputRange: inputRange,
                    outputRange: getTextOpacity(numOfDisplayedItems)
                  })
              ...
              <ItemText
                ...
                style={[{
                  ...
                  opacity: animationValue.interpolate({
                    inputRange: inputRange,
                    outputRange: getSelectedColor(numOfDisplayedItems)
                  })
                  // color: animationValue.a
                }, {width: 100, padding: 10, textAlign: 'center', color: selectedColor, position: 'absolute', borderTopWidth: 1, borderBottomWidth: 1, borderColor: selectedColor}]}>{value}</ItemText>
            </Item>
          </View>
        );
      }),
